...
class PopUpViewController: UIViewController {
    ...
    @IBAction func saveChanges(_ sender: Any) {
        if editCategory == false {
            ...
            categories.append(titleOfAlbum.text!)
            ...
            print(existingName!)
            print(categories.index(of: existingName!)!)
            categories[categories.index(of: existingName!)!] = titleOfAlbum.text!
            defaults.set(categories, forKey: "AllCategories")
            
            let fetchPredicate = NSPredicate(format: "category == %@", "\(existingName!)")
            ...
            do {
                ...
                for fetchedUser in fetchedUsers {
                    fetchedUser.setValue(titleOfAlbum.text!, forKey: "category")
